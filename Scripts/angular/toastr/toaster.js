...
.service('toaster', ['$rootScope', '$q', function ($rootScope, $q) {
	this.pop = function (params) {
		...
		// AEP-209, Andreas Uppström, 2014-11-06, Returns deferred object to be able to use in combination with $animate
		return $q.when();
	};
